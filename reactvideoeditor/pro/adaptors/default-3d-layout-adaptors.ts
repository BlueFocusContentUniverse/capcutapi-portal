...
export const layout3DTemplates: Record<string, Layout3DTemplate> = {
  ...
  cardLeft: {
    ...
    transform: () => ({
      transform:
        "perspective(800px) rotateY(-25deg) rotateX(10deg) translateZ(20px)",
      transformStyle: "preserve-3d",
      zIndex: 15,
    }),
  },
  ...
  book: {
    ...
    transform: () => ({
      transform:
        "perspective(1200px) rotateY(-45deg) rotateX(15deg) translateZ(30px)",
      transformStyle: "preserve-3d",
      zIndex: 20,
    }),
  },
  floating: {
    ...
    transform: () => ({
      transform:
        "perspective(1000px) translateZ(50px) rotateX(-5deg) rotateY(10deg)",
      transformStyle: "preserve-3d",
      zIndex: 25,
    }),
  },
  ...
  skewed: {
    ...
    transform: () => ({
      transform:
        "perspective(600px) rotateY(-35deg) rotateX(25deg) skewX(-5deg)",
      transformStyle: "preserve-3d",
      zIndex: 30,
    }),
  },
 ...
 */
export const default3DLayoutAdaptor = createStatic3DLayoutAdaptor(
  layout3DTemplates,
  "Default 3D Layouts",
);

 ...
 */
export const TimelineMarqueeSelection: React.FC<
  TimelineMarqueeSelectionProps
> = ({ isMarqueeSelecting, marqueeStartPoint, marqueeEndPoint }) => {
  ...
  return (
    <div
      className="absolute border-[1.5px] border-(--primary) pointer-events-none rounded-sm"
      style={{

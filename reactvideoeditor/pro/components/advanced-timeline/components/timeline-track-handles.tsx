  ...
  return (
    <div
      ...
      style={{
        ...
        overflowX:
          "scroll" /* We don't need scroll but since it shows in timeline this keeps us at same height  */,
      }}
    >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide track-handles-scroll">
        {tracks.map((track, index) => {
          ...
          const getTrackClasses = () => {
            const baseClasses =
              "track flex items-center px-3 gap-1 border-border";
          ...
          return (
            ...
            >
              ...
              >
                <GripVertical
                  className={`w-3 h-3 ${isBeingDragged ? "text-primary" : "text-muted-foreground"}`}
                />
              </div>

...
export const useTimelineOperations = ({
  ...
  const handleExternalItemMove = useCallback(
  ...
  const handleExternalItemResize = useCallback(
  ...
  const handleExternalItemsDelete = useCallback(
    (itemIds: string[]) => {
  ...
  const handleExternalItemsDuplicate = useCallback(
    (itemIds: string[]) => {
  ...
  const handleExternalItemSplit = useCallback(
  ...
  const handleExternalAddNewItem = useCallback(
    (item: any) => {
      onAddNewItem?.(item);
    },
    [onAddNewItem],

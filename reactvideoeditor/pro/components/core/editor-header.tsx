...
export function EditorHeader({
  ...
  const resolvedShowDefaultThemes =
    showDefaultThemes ?? themeConfig?.showDefaultThemes ?? true;
  const resolvedHideThemeToggle =
    hideThemeToggle ?? themeConfig?.hideThemeToggle ?? false;
  ...
  return (
    ...
    >
      ...
      {/* Render controls */}
      <RenderControls handleRender={renderMedia} state={renderState} />
    </header>
  );
}

...
export const CaptionsOverlayPanel: React.FC = () => {
  ...
  const { overlays, selectedOverlayId, changeOverlay, currentFrame } =
    useEditorContext();
  ...
  const handleSRTFileUpload = async (
    ...
    <div className="flex flex-col gap-4 p-2 h-full [&_[data-radix-scroll-area-viewport]]:!scrollbar-none">
      {!localOverlay ? (
        <>
          {/* Show errors if any */}
          {lastParseResult &&
            !lastParseResult.success &&
            lastParseResult.errors && (
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 rounded-sm">
                <Button
                  ...
                  onClick={() =>
                    document.getElementById("srt-file-upload")?.click()
                  }
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-extralight text-foreground">
                    Generate from Text
                  </span>
                </div>
                <Textarea

 ...
 */
export const SVGStickerComponent: React.FC<
  StickerComponentProps & { svgContent: string }
> = ({ overlay, isSelected, svgContent }) => {
 ...
 */
export const AnimatedStickerComponent: React.FC<
  StickerComponentProps & { animationType: string }
> = ({ overlay, isSelected, animationType }) => {

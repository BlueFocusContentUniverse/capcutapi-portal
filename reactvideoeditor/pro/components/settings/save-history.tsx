...
export const SaveHistory: React.FC = () => {
  ...
  const loadSaveHistory = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to load save history",
      );
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b bg-muted/50">
                  <th className="text-left px-3 py-2 text-muted-foreground font-extralight">
                    Aspect
                  </th>
                  <th className="text-left px-3 py-2 text-muted-foreground font-extralight">
                    Time
                  </th>
                  <th className="text-right px-3 py-2 text-muted-foreground font-extralight w-20">
                    Actions
                  </th>
                </tr>
              </thead>

...
export const MobileWarningModal: React.FC<MobileWarningModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0">
      <div
      ...
      >
        ...
        <div className="text-sm font-extralight text-muted-foreground text-center space-y-2 mb-6">
          <p>
            React Video Editor works best as a{" "}
          ...
          <p>
            You can still use it on your mobile device, but we&apos;ve reduced
            some features for a cleaner UI. Keep in mind that performance
            depends on your mobile browser&apos;s capabilities.
          </p>
        </div>

        {/* Button */}
        <Button onClick={handleDismiss} variant="default" className="w-full">

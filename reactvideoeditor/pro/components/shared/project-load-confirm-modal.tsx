...
export const ProjectLoadConfirmModal: React.FC<
  ProjectLoadConfirmModalProps
      ...
      >
        ...
        <div className="text-sm font-extralight text-muted-foreground mb-4">
          <p>
            ...
            . Loading this project will replace your current changes. This
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
          <Button onClick={onCancel} variant="outline" className="mt-2 sm:mt-0">
            Keep My Work
          </Button>

...
export function useProjectStateFromUrl(
  ...
  useEffect(() => {
    ...
    const loadProjectState = async () => {
      try {
        ...
        const projectAspectRatio: AspectRatio | undefined =
          projectData.aspect_ratio || projectData.aspectRatio;
  ...
  const onCancelLoad = () => {
    console.log("[useProjectStateFromUrl] User chose to keep existing work");
    setOverlays(fallbackOverlaysRef.current);
    pendingProjectDataRef.current = null;
    setShowModal(false);
  };

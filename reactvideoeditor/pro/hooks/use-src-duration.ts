...
export const useSrcDuration = (
      ...
      try {
        ...
        if (src instanceof File) {
          ...
          if (typeof window !== "undefined") {
            ...
            throw new Error(
              "File objects are not supported in Node.js environment. Use file path string instead.",
            );
          }
        } else {
          ...
          if (src.startsWith("/") && typeof window === "undefined") {
            ...
            throw new Error(
              "Local file paths in Node.js environment are not supported in this context. Use URLs instead.",
            );
          }
        }
        ...
        setError(
          err instanceof Error ? err.message : "Failed to parse media duration",
        );
      } finally {
        if (!isCancelled) {
          setIsLoading(false);
  ...
  const durationInFrames =
    durationInSeconds !== null ? Math.round(durationInSeconds * fps) : null;
